(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcApp_helpersFakeBackendTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var usersKey = 'users-key';
      var loansKey = 'loans-key';
      var users = JSON.parse(localStorage.getItem(usersKey)) || [];
      var loans = JSON.parse(localStorage.getItem(loansKey)) || [];
        ...
        _createClass(FakeBackendInterceptor, [{
          ...
          value: function intercept(request, next) {
            ...
            function registerLoan() {
              var loan = body;
              loan.id = loans.length ? Math.max.apply(Math, _toConsumableArray(loans.map(function (x) {
                return x.id;
              }))) + 1 : 1;
              loans.push(loan);
            ...
            function getLoans() {
              if (!isLoggedIn()) return unauthorized();
              return ok(loans.map(function (x) {
                return basicLoanDetails(x);
              }));
            }
            ...
            function getLoanById() {
              if (!isLoggedIn()) return unauthorized();
              var loan = loans.find(function (x) {
                return x.id === idFromUrl();
              });
              loan.id = idFromUrl();
            ...
            function updateLoan() {
              if (!isLoggedIn()) return unauthorized();
              var toupdateid = idFromUrl();
              var params = body;
              var loan = loans.find(function (x) {
                return x.id === idFromUrl();
              });
              params.id = toupdateid; // update and save user
            ...
            function basicDetails(user) {
              var id = user.id,
                  ...
                  refAccountholderAccountNumber = user.refAccountholderAccountNumber;
              return {
                id: id,
                username: username,
                firstName: firstName,
                ...
                refAccountholderAccountNumber: refAccountholderAccountNumber
              };
            }
    ...
    function srcApp_modelsIndexTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _loan__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./loan */
      "./src/app/_models/loan.ts");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "Loan", function () {
        return _loan__WEBPACK_IMPORTED_MODULE_2__["Loan"];
      });
      /***/
    ...
    /***/
    function srcApp_modelsLoanTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcApp_servicesIndexTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _loan_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./loan.service */
      ...
      __webpack_require__.d(__webpack_exports__, "LoanService", function () {
        return _loan_service__WEBPACK_IMPORTED_MODULE_1__["LoanService"];
      });
      /* harmony import */
    ...
    /***/
    function srcApp_servicesLoanServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var LoanService = /*#__PURE__*/function () {
        function LoanService(router, http, accountService) {
        ...
        _createClass(LoanService, [{
          ...
          // }
          value: function register(loan) {
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/loans/add"), loan);
          }
        }, {
          key: "getAll",
          value: function getAll() {
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/loans"));
          }
        }, {
          key: "getById",
          value: function getById(id) {
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/loans/").concat(id));
          }
        }, {
          key: "update",
          value: function update(id, params) {
            ...
            return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/loans/").concat(id), params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) {
              // update stored loan if the logged in user updated their own record
              params.username = _this7.accountService.currentUser.username; // update local storage

              var loan = Object.assign(Object.assign({}, _this7.loanValue), params);
              console.log(loan);
              localStorage.setItem('loan', JSON.stringify(loan)); // publish updated loan to subscribers

              _this7.loanSubject.next(loan);
          ...
          key: "delete",
          value: function _delete(id) {
            return this.http["delete"]("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/loans/").concat(id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) {
              return x;
            }));
          }
        }, {
      ...
      LoanService.ɵfac = function LoanService_Factory(t) {
        return new (t || LoanService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_account_service__WEBPACK_IMPORTED_MODULE_6__["AccountService"]));
      };
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var loansModule = function loansModule() {
        return __webpack_require__.e(
        /*! import() | loans-loans-module */
        "loans-loans-module").then(__webpack_require__.bind(null,
        /*! ./loans/loans.module */
        "./src/app/loans/loans.module.ts")).then(function (x) {
          return x.LoansModule;
        });
      };
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 8,
        vars: 4,
        consts: [["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], [1, "app-container", 3, "ngClass"], [1, "text-center", "mt-4"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/users", "routerLinkActive", "active", 1, "nav-item", "nav-link"], ["routerLink", "/loans", "routerLinkActive", "active", 1, "nav-item", "nav-link"], [1, "nav-item", "nav-link", 3, "click"]],
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/core.js"); // used to create fake backend
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Source\IBIBS-Angular\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
